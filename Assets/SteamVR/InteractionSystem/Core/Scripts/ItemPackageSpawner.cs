...
namespace Valve.VR.InteractionSystem {
    ...
    public class ItemPackageSpawner : MonoBehaviour {
        ...
        [SerializeField] public bool canTakeBackItem = true;
        ...
        public bool shouldInvokePickupEventIndefinitely = false;
        private int pickupInvokeCount = 0;
        public UnityEvent pickupEvent;
        public bool shouldInvokeDropEventIndefinitely = false;
        private int dropInvokeCount = 0;
        ...
        void Update () {
            if ((itemIsSpawned == true) && (spawnedItem == null)) {
                ...
                if (shouldInvokeDropEventIndefinitely && dropInvokeCount != 0) {
                    dropEvent.Invoke ();
                    dropInvokeCount++;
                }
        ...
        private void OnHandHoverBegin (Hand hand) {
            ...
            if (requireTriggerPressToTake && showTriggerHint) {
                ControllerButtonHints.ShowTextHint (hand, Valve.VR.EVRButtonId.k_EButton_SteamVR_Trigger, "Pick me");
            }
        }
